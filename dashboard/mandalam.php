...
requireLogin();
if ($_SESSION['role'] != 'mandalam_admin') {
...
<head>
    <title>Mandalam Admin Dashboard</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="#">Mandalam Admin Dashboard</a>
    ...
    <div class="dashboard">
        <div class="header">
            ...
            <p class="d-flex gap-2 flex-wrap justify-content-end">
                <a href="../admin/manage_structure.php?level=localbody" class="btn btn-manage">Manage Organizations</a>
